...
#Funções dentro do menu de cursos
  def IncluirCurso():
    while True:
      ...
      while True:
        try:
          id_cursoV = int(input("Digite o ID do curso: "))
          id_curso.append(str(id_cursoV))
          break
        except ValueError:
          print("Por favor, digite um ID de curso como um número inteiro.")
      nome_cursoV = input("Digite o nome do curso: ")
      nome_curso.append(nome_cursoV)
      while True:
        try:
          duracao_cursoV = int(input("Digite a duração do curso: "))
          duracao_curso.append(str(duracao_cursoV))
          break
        except ValueError:
          print("Por favor, digite uma duração de curso como um número inteiro.")
  ...
  def RelatorioCurso():
    while True:
      ...
      print("Relatório")
      i = 0
      for i in range (0, len(nome_curso)):
